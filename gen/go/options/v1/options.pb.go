...
var file_options_v1_options_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Field:         50001,
		Name:          "options.v1.usage",
		Tag:           "bytes,50001,opt,name=usage",
...
var (
	// optional string usage = 50001;
	E_Usage = &file_options_v1_options_proto_extTypes[0]
)
...
const file_options_v1_options_proto_rawDesc = "" +
	...
	"options.v1\x1a google/protobuf/descriptor.proto:5\n" +
	"\x05usage\x12\x1d.google.protobuf.FieldOptions\x18ц\x03 \x01(\tR\x05usageB\x9d\x01\n" +
	"\x0ecom.options.v1B\fOptionsProtoP\x01Z4github.com/omcrgnt/proto/gen/go/options/v1;optionsv1\xa2\x02\x03OXX\xaa\x02\n" +
	"Options.V1\xca\x02\n" +
...
var file_options_v1_options_proto_depIdxs = []int32{
	0, // 0: options.v1.usage:extendee -> google.protobuf.FieldOptions
